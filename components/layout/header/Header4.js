...
export default function Header4({ scroll, isMobileMenu, handleMobileMenu, transparent, isSearch, isOffcanvus, handleOffcanvus, handleSearch }) {
    return (
        <>
            <header className="tg-header__style-four transparent-header">
                ...
                <div id="sticky-header" className={`tg-header__area  tg-header__area-four ${scroll ? "sticky-menu" : ""}`}>
                    <div className="container">
                        <div className="row">
                                    ...
                                    <nav className="tgmenu__nav">
                                        ...
                                        <div className="tgmenu__action tgmenu__action-four d-none d-md-block">
                                            <ul className="list-wrap">
                                                ...
                                                <li className="header-btn"><Link href="/contact" className="btn">log in</Link></li>
