                            ...
                            <div className="choose__content-three">
                                ...
                                <div className="about__list-box ">
                                        <ul className="list-wrap">
                                            <li><i className="flaticon-arrow-button" />Annual Reports</li>
                                            <li><i className="flaticon-arrow-button" />Disclosures</li>
                                            <li><i className="flaticon-arrow-button" />Investor Relations Contact</li>
                                            <li><i className="flaticon-arrow-button" />Financial Statements</li>
