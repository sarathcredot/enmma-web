        ...
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="About Us">
                <div>
                                ...
                                <div className="col-lg-6">
                                    <div className="about__content-three">
                                        <div className="section-title mb-25">
                                            ...
                                            <h2 className="title">Providing Expert Advice On Business Consulting, Planning  Success</h2>
                                        </div>
                    ...
                    {/* team-area-end */}
                    {/* testimonial-area */}
                    <section1 className="testimonial__area-three testimonial__bg" data-background="/assets/img/bg/h3_testimonial_bg.jpg">
                        <div className="container">
                            <div className="row align-items-center justify-content-center">
