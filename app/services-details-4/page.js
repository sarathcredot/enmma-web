...
export default function ServicesDetails4() {
    return (
        <>
                                                ...
                                                <div className="row gutter-24 align-items-center">
                                                    <div className="col-lg-7">
                                                        <div className="services__details-inner-content-three">
                                                            ...
                                                            <p>eed a little help from our friends from time to time. Although we offer the one-stop convenience of annery integrated range of legal, financial services under one roof, there are occasions.eed a little help from our friends from time to time. Although we offer the one-stop convenience of annery integrated range of legal, financial services under one roof.</p>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-5">
                                                        <div className="services__details-list-box">
                                                            ...
                                                            <div className="content">
                                                                ...
                                                                <p>successfully copey withtks arying mplexity</p>
                                                            </div>
                                                        </div>
                                                        <div className="services__details-list-box">
                                                            <div className="icon">
                                                ...
                                                <div className="row gutter-24 align-items-center">
                                                    <div className="col-48">
                                                        <div className="services__details-inner-img">
                                                            <img src="/assets/img/services/services_details_inner04.jpg" alt="" />
                                                        </div>
                                                    </div>
